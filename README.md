...
The project delivers a Windows app that provides **interactive GUI**, **data processing**, amd **data export** functionality from the client's raw data source, utilising [pandas](https://pandas.pydata.org/), an open-source data analysis library, and other supplementary [Python](https://www.python.org/) frameworks.
...
<img src='docs/tree.png' style='width:400px'/>

Import result:
<img src='docs/import-1.png' style='width:200px'/>
...
<img src='docs/import-2.png' style='width:400px'/>

Filter result:
<img src='docs/import-3.png' style='width:200px'/>
...
<img src='docs/filter-1.png' style='width:400px'/>
...
<img src='docs/stack-1.png' style='width:400px'/>
...
<img src='docs/dup-2.png' style='width:500px'/><br>
...
<img src='docs/dup-1.png' style='width:400px'/>
...
<img src='docs/export-2.png' style='width:400px'/><br>
...
- ##### Anything actions when no root folder is specified
    <img src='docs/err-1.png' style='width:300px'/>
- ##### Wrong date format
    <img src='docs/err-2.png' style='width:300px'/>
- ##### Try export with no CSV
    <img src='docs/err-3.png' style='width:300px'/>
- ##### Check for empty output
    <img src='docs/err-4.png' style='width:300px'/>
...
You can clone the source code with the following command to start debugging / testing _([git-scm](https://git-scm.com/) for Windows is required)_:
